...
ClickButton pulsador(PIN_pulsador, 40, 120, 380, false);   	// creacion de un objeto definiendo todos sus parametros:
														    // uint8_t pin, uint8_t antirrebotes, uint16_t corta, uint16_t larga, PULLUP
...
{ 
  ...
  /* Deteccion de pulsacion mantenida */
    ...
    Serial.print(F("MANTENIDA "));Serial.println(++contadorMantenida);
    digitalWrite(LED_OnBoard, HIGH);
    delay(350);
    digitalWrite(LED_OnBoard, LOW);
  }
