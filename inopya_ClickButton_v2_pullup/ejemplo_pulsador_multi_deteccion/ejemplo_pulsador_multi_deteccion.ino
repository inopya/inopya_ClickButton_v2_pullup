...
/*
 # NOTAS DE LA VERSION
  ...
  Esta libreria permite el control de pulsadores en los que podremos detectar 4 tipos de eventos 
  ...
  *******************************************************
   >> solo con el numero de pin
      ClickButton mi_pulsador_1(uint8_t pin); el resto de parametros por defecto: son (30,150,380,false)
   
   >> o bien definiendo todos los parametros disponibles
      ClickButton mi_pulsador_2(uint8_t pin, uint8_t antirrebotes, uint16_t corta, uint16_t larga, false);
...
ClickButton pulsador_1(PIN_pulsador, 40, 120, 380, false);   // creacion de un objeto definiendo todos sus parametros:
